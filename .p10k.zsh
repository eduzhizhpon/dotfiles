# Generated by Powerlevel10k configuration wizard on 2023-11-12 at 11:31 -05.
...
() {
  ...
  # isdcon overlap when using non-monospace fonts. When set to `none`, spaces are not added.
